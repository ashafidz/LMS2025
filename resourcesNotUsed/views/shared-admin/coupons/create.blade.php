                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-block">
                                    ...
                                    <form action="{{ route(Auth::user()->getRoleNames()->first() . '.coupons.store') }}" method="POST">
                                        @csrf
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Kode Kupon</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="code" class="form-control" value="{{ old('code') }}" required placeholder="Contoh: BELAJARHEMAT25">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                                <select name="type" class="form-control" required>
                                                    <option value="fixed" {{ old('type') == 'fixed' ? 'selected' : '' }}>Potongan Harga Tetap (Rp)</option>
                                                    <option value="percent" {{ old('type') == 'percent' ? 'selected' : '' }}>Persentase (%)</option>
                                                </select>
                                            </div>
                                            <label class="col-sm-2 col-form-label">Nilai Diskon</label>
                                            <div class="col-sm-4">
                                                <input type="number" name="value" class="form-control" value="{{ old('value') }}" required placeholder="Contoh: 50000 atau 25">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" name="max_uses" class="form-control" value="{{ old('max_uses') }}" placeholder="Kosongkan jika tidak terbatas">
                                            </div>
                                        </div>
                                        <div class="form-group row">
