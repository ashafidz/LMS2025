                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-12 d-flex mt-3">
                        <ul class="breadcrumb-title">
                            ...
                            <li class="breadcrumb-item"><a
                                    href="{{ route(Auth::user()->getRoleNames()->first() . '.coupons.index') }}">Kupon</a>
                            </li>
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    ...
                                    <div class="card-block">
                                        ...
                                        <form action="{{ route(Auth::user()->getRoleNames()->first() . '.coupons.store') }}"
                                            method="POST">
                                            @csrf
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="code" class="form-control"
                                                        ...
                                                        placeholder="Contoh: BELAJARHEMAT25">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-4">
                                                    <select name="type" class="form-control" required>
                                                        <option value="fixed"
                                                            {{ old('type') == 'fixed' ? 'selected' : '' }}>Potongan Harga
                                                            Tetap (Rp)</option>
                                                        <option value="percent"
                                                            {{ old('type') == 'percent' ? 'selected' : '' }}>Persentase (%)
                                                        </option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="col-sm-4">
                                                    <input type="number" name="value" class="form-control"
                                                        ...
                                                        placeholder="Contoh: 50000 atau 25">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="form-check form-switch">
                                                        ...
                                                        <label class="form-check-label" for="is_public">Jadikan Kupon Publik
                                                            (terlihat oleh semua pengguna di keranjang).</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <hr>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-5">
                                                    ...
                                                    <small class="form-text text-muted">Tanggal Kedaluwarsa
                                                        (Opsional)</small>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                    ...
                                                    <div class="form-radio">
                                                        <div class="radio radio-inline">
                                                            <label><input type="radio" name="is_active" value="1"
                                                                    {{ old('is_active', '1') == '1' ? 'checked' : '' }}><i
                                                                    class="helper"></i>Aktif</label>
                                                        </div>
                                                        <div class="radio radio-inline">
                                                            <label><input type="radio" name="is_active" value="0"
                                                                    {{ old('is_active') == '0' ? 'checked' : '' }}><i
                                                                    class="helper"></i>Tidak Aktif</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-sm-12 text-right">
                                                    <a href="{{ route(Auth::user()->getRoleNames()->first() . '.coupons.index') }}"
