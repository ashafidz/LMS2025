            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <div class="page-header-title">
                        ...
                        <p class="m-b-0">Perbarui detail untuk topik: {{ $topic->name }}</p>
                    </div>
                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="available_for_all_courses" value="1" id="all-courses-checkbox" {{ old('available_for_all_courses', $topic->available_for_all_courses) ? 'checked' : '' }}>
                            ...
                            <div class="form-group row" id="course-list-container">
                                ...
                                <div class="col-sm-10">
                                    {{-- <div class="card p-3" style="max-height: 200px; overflow-y: auto;"> --}}
                                        ...
                                        @php $linkedCourseIds = $topic->courses->pluck('id')->toArray(); @endphp
                                        @forelse($courses as $course)
                                            <div class="form-check">
                                                <input class="form-check-input course-checkbox" type="checkbox" name="course_ids[]" value="{{ $course->id }}" id="course-{{ $course->id }}" {{ in_array($course->id, old('course_ids', $linkedCourseIds)) ? 'checked' : '' }}>
