            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-12 d-flex mt-3">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!">Sinkronisasi Massal</a></li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-block">
                            @if(count($anomalies) > 0)
                                ...
                                <form action="{{ route('instructor.courses.mass_sync.execute', $course) }}" method="POST" onsubmit="return confirm('Anda yakin ingin menyinkronkan {{ count($anomalies) }} data poin ini secara permanen?');">
                                    @csrf
                            ...
                            @else
                                <div class="text-center p-5">
                                    ...
                                    <a href="{{ route('instructor.courses.index') }}" class="btn btn-secondary mt-3"><i class="fa fa-arrow-left"></i> Kembali ke Daftar Kursus</a>
                                </div>
                            @endif
                        </div>
                    </div>
