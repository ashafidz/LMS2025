...
<style>
    ...
    .btn-outline-primary { color: black; border-color: black; background-color: white; }
    .btn-outline-primary:hover { background-color: #333; color: white; border-color: black; }
    .btn-check:checked+.btn-outline-primary { background-color: black !important; color: white !important; border-color: black !important; }
</style>
            ...
            <div class="card shadow-sm border-0" style="max-width: 450px; width: 100%;">
                <div class="card-body p-5">
                    ...
                    <form method="POST" action="{{ route('login') }}" class="main-login-form">
                        ...
                        <div class="d-grid"><button type="submit" class="btn btn-dark">{{ __('Log in') }}</button></div>
                    </form>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="POST" action="{{ route('password.email') }}" class="forgot-password-form">
                    ...
                    <div class="d-grid mt-4"><button type="submit" class="btn btn-dark">{{ __('Email Password Reset Link') }}</button></div>
                </form>
            </div>
        </div>
    </div>
