    ...
    <div class="card shadow-lg border-0" style="max-width: 750px; width: 100%; border-radius: 20px;">
      <div class="card-body text-center p-5">
        ...
        <p class="mb-4" style="color: #5e5e5e; line-height: 1.4;">
          Yth. Instructor, setelah kami melakukan peninjauan, kami ingin menginformasikan bahwa akun Instructor Anda telah ditolak oleh tim kami.
          Keputusan ini diambil demi menjaga kualitas dan kenyamanan seluruh pengguna.
