...
<div class="row g-0 h-100"> 
    ...
    {{-- column for register card --}} 
    {{-- CHANGE 3: Added flexbox classes to center the card vertically --}}
    <div class="col-12 col-md-6 d-flex align-items-center"> 
        {{-- Your original wrapping div for centering the card horizontally is still here and works fine --}}
