                                    ...
                                    <div class="card-block">
                                        ...
                                        <form action="{{ route('superadmin.settings.update') }}" method="POST"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    @if ($settings->logo_path)
                                                        <img src="{{ Storage::url($settings->logo_path) }}" alt="Logo"
                                                            style="max-height: 50px; background-color: #f2f2f2; padding: 5px; border-radius: 5px;">
                                                    @else
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="number" name="vat_percentage" class="form-control"
                                                        ...
                                                        required step="0.01">
                                                    <small class="form-text text-muted">Masukkan nilai persentase. Contoh:
                                                        11 untuk 11%.</small>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    <small class="form-text text-muted">Biaya tetap yang ditambahkan ke
                                                        setiap transaksi. Masukkan 0 jika tidak ada.</small>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label">Biaya Transaksi Persen (%)</label>
                                                <div class="col-sm-9">
                                                    <input type="number" name="transaction_fee_percentage"
                                                        class="form-control"
                                                        value="{{ old('transaction_fee_percentage', $settings->transaction_fee_percentage) }}"
                                                        required step="0.01">
                                                    <small class="form-text text-muted">Biaya persentase yang ditambahkan
                                                        ke setiap transaksi. Masukkan 0 jika tidak ada.</small>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9"><input type="number" name="points_for_purchase"
                                                        class="form-control"
                                                        value="{{ old('points_for_purchase', $settings->points_for_purchase) }}"
                                                        required></div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label">Poin Selesai Pelajaran
                                                    (Artikel)</label>
                                                <div class="col-sm-9"><input type="number" name="points_for_article"
                                                        class="form-control"
                                                        value="{{ old('points_for_article', $settings->points_for_article) }}"
                                                        required></div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label">Poin Selesai Pelajaran
                                                    (Video)</label>
                                                <div class="col-sm-9"><input type="number" name="points_for_video"
                                                        class="form-control"
                                                        value="{{ old('points_for_video', $settings->points_for_video) }}"
                                                        required></div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label">Poin Selesai Pelajaran
                                                    (Dokumen)</label>
                                                <div class="col-sm-9"><input type="number" name="points_for_document"
                                                        class="form-control"
                                                        value="{{ old('points_for_document', $settings->points_for_document) }}"
                                                        required></div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label">Poin Lulus Kuis</label>
                                                <div class="col-sm-9"><input type="number" name="points_for_quiz"
                                                        class="form-control"
                                                        value="{{ old('points_for_quiz', $settings->points_for_quiz) }}"
                                                        required></div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label">Poin Lulus Tugas</label>
                                                <div class="col-sm-9"><input type="number" name="points_for_assignment"
                                                        class="form-control"
                                                        value="{{ old('points_for_assignment', $settings->points_for_assignment) }}"
                                                        required></div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label">Poin Menyelesaikan Polling</label>
                                                <div class="col-sm-9"><input type="number" name="points_for_polling"
                                                        class="form-control"
                                                        value="{{ old('points_for_polling', $settings->points_for_polling) }}"
                                                        required></div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label">Rasio Konversi Poin ke
                                                    Diamond</label>
                                                <div class="col-sm-9">
                                                    <input type="number" name="point_to_diamond_rate"
                                                        class="form-control"
                                                        value="{{ old('point_to_diamond_rate', $settings->point_to_diamond_rate) }}"
                                                        required step="0.01">
                                                    <small class="form-text text-muted">Masukkan nilai rasio. Contoh: 1.0
                                                        untuk 1:1, atau 0.7 untuk 70%.</small>
                                                </div>
                                            </div>
