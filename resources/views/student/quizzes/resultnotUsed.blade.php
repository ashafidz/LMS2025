                                ...
                                <div class="card-block">
                                    @foreach($attempt->quiz->questions as $index => $question)
                                        <div class="mb-5">
                                            ...
                                            @php
                                                // Ambil semua jawaban siswa untuk pertanyaan ini
                                                ...
                                                @foreach($question->options as $option)
                                                    @php
                                                        ...
                                                        if ($isStudentAnswer && $isCorrectAnswer) {
                                                            ...
                                                            $labelClass = 'bg-info text-white'; // Bukan jawaban siswa, tapi ini jawaban yang benar
                                                        }
                                                    @endphp
                                                    <div class="p-2 rounded mb-2 {{ $labelClass }}">
                                                        @if($isStudentAnswer)
                                                            <i class="fa fa-check-circle-o mr-2"></i> <strong>Jawaban Anda:</strong>
                                            ...
                                            {{-- Tampilkan Penjelasan jika jawaban benar dan ada penjelasan --}}
