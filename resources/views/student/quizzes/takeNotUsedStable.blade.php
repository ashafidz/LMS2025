...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function createNavigation() {
        questions.forEach((question, index) => {
            ...
            navBtn.type = 'button';
            navBtn.className = 'btn btn-outline-secondary m-1'; // Warna default
    ...
    // FUNGSI BARU: Memeriksa dan menandai soal yang sudah dijawab
    function updateNavigationStatus() {
        ...
        navButtons.forEach((btn, index) => {
            ...
            if (index === currentQuestionIndex) {
                btn.className = 'btn btn-primary m-1'; // Soal aktif
            } else if (isAnswered) {
                btn.className = 'btn btn-secondary m-1'; // Soal sudah dijawab
            } else {
                btn.className = 'btn btn-outline-secondary m-1'; // Soal belum dijawab
            }
        });
    }
    ...
    // Tambahkan event listener ke form untuk mendeteksi perubahan jawaban
