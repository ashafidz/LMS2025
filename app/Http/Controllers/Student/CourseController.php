...
class CourseController extends Controller
{
    ...
    public function show(Request $request, Course $course)
    {
        ...
        if ($user) {
            ...
            // KODE PERBAIKAN YANG LEBIH ANDAL
            // 1. Ambil semua ID lesson yang ada di kursus ini
            $courseLessonIds = $course->lessons()->pluck('lessons.id');

            // 2. Query ke tabel pivot 'lesson_user' secara langsung dan filter berdasarkan user dan lesson dari kursus ini
