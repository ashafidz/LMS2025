...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (!Schema::hasColumn('adaptive_modules', 'target_archetypes')) {
        ...
        if (Schema::hasColumn('adaptive_modules', 'archetype_name')) {
        ...
        if (!Schema::hasColumn('ai_generation_jobs', 'module_id')) {
        ...
        if (Schema::hasColumn('ai_references', 'archetype_name')) {
